window.ABOUT_DATA = {
  ...
  news: [
    ...
    { year: 2026, month: 1, content: "Awarded the <strong>Xiaomi Scholarship</strong>." },
    { year: 2025, month: 9, content: "Awarded the <strong>Shanghai Scholarship</strong> after a year that included ranking <strong>#1 in GPA</strong>, publishing four first-author papers at <strong>CCF-C</strong> ranked conferences, and winning multiple national programming contest awards." },
  ...
  engagement: [
    ...
    },
    {
      ...
      items: [
        { event: "Poster Presentation at KDD 2026", role: 'Presented "APCL"' },
